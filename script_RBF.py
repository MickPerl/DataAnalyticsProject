...
try : 
    ...
    file, _ = urlretrieve(url = "https://github.com/MickPerl/DataAnalyticsProject/releases/download/dataset_script/df_script.csv", filename= os.path.join("df_script", "df_script_RBF.csv"))
    df = pd.read_csv(file)
