...
if __name__ == "__main__":
	...
	for config_params in all_configs:
		...
		with SummaryWriter(log_dir=os.path.join('tensorboard_logs', f"regression_fine_tuning", 'Train_' + str(nr_train), name_run)) as tb:
	...
	results.to_csv("results_NN_regression.csv", index=False)
